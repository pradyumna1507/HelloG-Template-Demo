    ...
    _fields.addAll([
      ...
      FieldModel(
        ...
        options: [
          ...
          OptionModel(value: 'other', label: {'en': 'Other'}),
        ],
      ),
      FieldModel(
        key: 'department',
        ...
        order: 5,
        options: [
          OptionModel(value: 'engineering', label: {'en': 'Engineering'}),
          OptionModel(value: 'sales', label: {'en': 'Sales'}),
          OptionModel(value: 'marketing', label: {'en': 'Marketing'}),
          OptionModel(value: 'hr', label: {'en': 'Human Resources'}),
        ],
      ),
      FieldModel(
        key: 'experience',
      ...
      FieldModel(
        ...
        order: 7,
        options: [
          OptionModel(value: 'communication', label: {'en': 'Communication'}),
          OptionModel(value: 'leadership', label: {'en': 'Leadership'}),
          OptionModel(value: 'technical', label: {'en': 'Technical'}),
          OptionModel(
